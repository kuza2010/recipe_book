...
public class SuggestionProvider extends ContentProvider{
     ...
     * íóæåí äëÿ ñîïîñòàâëåíèÿ ðàçíûì URI êîíêðåòíûõ çíà÷åíèé
     */
    ...
    //Òðåáóåìûå ìåòîäû (íàñëåäóþòñÿ îò êëàññà ContentProvider)
    @Override
